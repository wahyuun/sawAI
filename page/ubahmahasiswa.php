...
<form id="form" method="POST" action="./proses/prosesubah.php">
    ...
    <div class="panel-middle">
        <div class="group-input">
            ...
            <input type="text" value="<?php echo $data['namaSupplier']; ?>" class="form-custom" required autocomplete="off" placeholder="Masukkan Nama Mahasiswa Baru" id="supplier" name="supplier">
        </div>
    </div>
