                        ...
                        if ($execute->num_rows > 0){
                            ...
                            while($data=$execute->fetch_array(MYSQLI_ASSOC)){
                                ...
                                <tr id='data'>
                                    ...
                                    <a class=\"btn btn-light-green\" href='./?page=mahasiswa&aksi=ubah&id=".$data['id_supplier']."'><i class='fa fa-pencil-alt'></i></a>
                                    <a class=\"btn btn-yellow\" data-a=".$data['namaSupplier']." id='hapus' href='./proses/proseshapus.php/?op=mahasiswa&id=".$data['id_supplier']."'><i class='fa fa-trash-alt'></i></a>
                                    </div></td>
                                </tr>";
                                $no++;
                            }
