...
<form id="form" method="POST" action="./proses/prosesubah.php">
    ...
    <input type="hidden" name="id" value="<?= $data['id_nilaikriteria']; ?>">
    <div class="panel-middle">
        ...
        <div class="group-input">
            ...
            <input type="text" value="<?= $data['nilai']; ?>" class="form-custom" required autocomplete="off" placeholder="Nilai" id="Nilai" name="nilai">
        </div>
        <div class="group-input">
            <label for="keterangan" >Keterangan :</label>
            <input type="text" value="<?= $data['keterangan'] ?>" class="form-custom" required autocomplete="off" placeholder="Nama keterangan" id="keterangan" name="keterangan">
        </div>
    </div>
    <div class="panel-bottom">
        <button type="submit" id="buttonsimpan" class="btn btn-green"><i class="fa fa-save"></i> Ubah</button>
