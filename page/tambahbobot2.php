    ...
    <div class="panel-middle">
        <div class="group-input">
            ...
            <select class="form-custom" required name="barang" id="barang">
                <option selected disabled>--Pilih Nomor NIM/NPM--</option>
                <?php
                ...
                if ($execute->num_rows > 0){
                    ...
                    echo "<option value=\"\">Belum ada Nomor NIM/NPM</option>";
                }
                ?>
            </select>
        </div>
            ...
            while($data=$execute->fetch_array(MYSQLI_ASSOC)){
                echo "<div class=\"group-input\">
                        ...
                        <input type='hidden' value=$data[id_kriteria] name='kriteria[]'>
                            ...
                            <option selected disabled>--Pilih Bobot <span style=\"font-style: italic;\"> $data[namaKriteria]</span>--</option>";
